...
def register(users: Users):
    ...
    users_list.append({"email": users.email, "password": hashed_password})
    return users_list
...
def login(
    ...
    if email and password:
        ...
        current_user.joined_at, current_user.last_logged_in_at = time_to_str(
            current_user.joined_at
        ), time_to_str(current_user.last_logged_in_at)
